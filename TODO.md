...
- [x] Implement shared-MITRE-technique correlation (alerts mapped to the same/related techniques within a window) — real, tested code path (`Alert.mitre_mappings`), but inert in practice until Phase 8 populates technique mappings
